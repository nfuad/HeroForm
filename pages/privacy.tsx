  ...
  return (
    <Layout title="Privacy Policy">
      <div className="flex flex-col items-start justify-center w-full h-full max-w-3xl p-10 mx-auto text-left gap-y-4">
        ...
        <p>
          At {SITE_DATA.domain}, accessible from https://{SITE_DATA.domain}, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by
          {SITE_DATA.domain} and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in {SITE_DATA.domain}. This policy is not
        ...
        <p>
          {SITE_DATA.domain} follows a standard procedure of using log files.
        ...
        <p>
          ...
          advertising partners of {SITE_DATA.domain}.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on {SITE_DATA.domain}, which are
        ...
        <p>
          Note that {SITE_DATA.domain} has no access to or control over these
        ...
        <p>
          {SITE_DATA.domain}&apos;s Privacy Policy does not apply to other
        ...
        <p>
          {SITE_DATA.domain} does not knowingly collect any Personal
