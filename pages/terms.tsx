...
const TermsOfServicePage = () => (
  <Layout title="Terms of Service">
    <div className="flex flex-col items-start justify-center w-full h-full max-w-3xl p-10 mx-auto text-left gap-y-4">
      ...
      <p>
        By accessing this Website, accessible from https://{SITE_DATA.domain}
        .io, you are agreeing to be bound by these Website Terms and Conditions
      ...
      <p>
        ...
        on {SITE_DATA.domain}&apos;s Website for personal, non-commercial
      ...
      <p>
        This will let {SITE_DATA.domain} to terminate upon violations of any of
      ...
      <p>
        All the materials on {SITE_DATA.domain}’s Website are provided &quot;as
        is&quot;. {SITE_DATA.domain}
        makes no warranties, may it be expressed or implied, therefore negates
        all other warranties. Furthermore, {SITE_DATA.domain} does not make any
      ...
      <p>
        {SITE_DATA.domain} or its suppliers will not be hold accountable for any
        damages that will arise with the use or inability to use the materials
        on
        {SITE_DATA.domain}’s Website, even if {SITE_DATA.domain} or an authorize
      ...
      <p>
        The materials appearing on {SITE_DATA.domain}’s Website may include
        technical, typographical, or photographic errors. {SITE_DATA.domain}{' '}
        will not promise that any of the materials in this Website are accurate,
        complete, or current.
        {SITE_DATA.domain} may change the materials contained on its Website at
        any time without notice. {SITE_DATA.domain} does not make any commitment
      ...
      <p>
        {SITE_DATA.domain} has not reviewed all of the sites linked to its
        ...
        {SITE_DATA.domain} of the site. The use of any linked website is at the
        user’s own risk.
      </p>
      ...
      <p>
        {SITE_DATA.domain} may revise these Terms of Use for its Website at any
      ...
      <p>
        Any claim related to {SITE_DATA.domain}&apos;s Website shall be governed
        by the laws of bd without regards to its conflict of law provisions.
      </p>
    </div>
  </Layout>
)
