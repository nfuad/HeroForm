    ...
    <Container>
      {question && (
        <>
          ...
          {isShortText && (
            <input
              className="w-full max-w-3xl mx-auto mt-8 text-2xl px-7 py-7 font-heading rounded-3xl placeholder:text-gray-300 placeholder:font-body"
          ...
          {isLongText && (
            <textarea
              className="w-full max-w-3xl mx-auto mt-8 text-2xl resize-none px-7 py-7 font-heading rounded-3xl placeholder:text-gray-300 placeholder:font-body"
              placeholder={question.placeholder}
              style={{
                boxShadow: '0px 14px 39px 10px rgba(235, 145, 145, 0.2)',
              }}
